...
function core.perform_check_local_changes(
		git_root_path, git_utils, prompts, notify_func, get_select_prompt_active, set_select_prompt_active,
		set_input_prompt_active, set_debounce_interval, get_debounce_interval
)
